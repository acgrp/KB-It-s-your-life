...
-- 1. INSERT INTO <테이블명> VALUES (입력데이터1, 입력데이터2, ... );
insert into tbl_menu values (null, '딸기김치찌개', 9500, 5, 'Y');

insert into tbl_menu values (null, null, 9500, 5, 'Y');
-- [23000][1048] Column 'menu_name' cannot be null

# 문법2: 작성한 컬럼값만 제공
-- 2. INSERT INTO <테이블명>(컬럼명1,컬럼명2,...) VALUES (입력데이터1, 입력데이터2, ... );`
insert into tbl_menu(menu_name, menu_price, category_code, orderable_status)
values ('메론돈까스', 15000, 6, 'Y');
...
values(menu_code 100, '참기름막걸리', 5000, 'Y');

replace into tbl_menu
values(menu_code 100, '들기름막걸리', 5000, 'Y');
# 트랜잭션 처리
