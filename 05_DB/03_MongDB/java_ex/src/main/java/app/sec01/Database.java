...
public class Database {
    ...
    static MongoClient client; // MongoDB 클라이언트 인스턴스 (싱글톤) -> 애플리케이션 전체에서 공유 하는 단일 연결 객체
    static MongoDatabase database; // MongoDB 데이터베이스 인스턴스(싱글톤) -> practice_db 데이터베이스에 대한 접근 객체
