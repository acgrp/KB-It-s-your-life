...
public class EmployeeService {
    ...
    private void getDepartmentEmployees() throws SQLException {
        ...
        System.out.println("=== 부서 직원 찾기 ===");

        System.out.print("찾을 부서 : ");
        String deptTitle = sc.next();

        EmployeeVO employeeVO = new EmployeeVO();

        employeeVO.setDeptTitle(deptTitle);

        dao.selectDeptTitle(employeeVO);
    ...
    private void getDepartmentAvgSalary() throws SQLException {
        ...
        System.out.println("=== 부서별, 직급별 평균 급여 정보 조회 ===");
    ...
    private void getWorkingEmployees() throws SQLException {
        ...
        System.out.println("=== 현재 재직중인 직원 목록 조회 ===");
    ...
    private void increaseSalary() throws SQLException {
        ...
        employeeVO.setDeptCode(deptCode);

        dao.increaseSalary(employeeVO);
    }
