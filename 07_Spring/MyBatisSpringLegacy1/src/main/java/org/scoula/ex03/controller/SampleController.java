...
public class SampleController {
    ...
    public String ex06(RedirectAttributes ra) {
        ...
        // redirect : 브라우저에게 새 URL로 다시 요청하라고 지시(요청 2번)
...
/*    @GetMapping("/ex06-2")
    public String ex06_2(@RequestParam("name") String name, @RequestParam("age") int age){
    ...
    */
    @GetMapping("/ex06-2")
    public String ex06_2(@ModelAttribute SampleDTO sampleDTO){
